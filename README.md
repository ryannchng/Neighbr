...
1. Download the latest `.apk` from the [Releases](https://github.com/ryannchng/Neighbr/releases) page
...
> iOS is not currently distributed as a standalone build. Running on iOS requires building from source (see below).
...
- Android Studio and/or Xcode for emulator/simulator support
